...
\depstyle{outer bubble}{draw=gray!80, minimum height=20pt, rounded corners=10pt,
inner sep=5pt, top color=white, bottom color=gray!40}
\depstyle{inner bubble}{draw=gray!80, minimum height=14pt, rounded corners=8pt,
